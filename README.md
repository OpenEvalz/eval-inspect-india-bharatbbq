...
**Paper:** https://arxiv.org/abs/2607.25375

Evaluates social bias in LLM responses within the Indian context, part of the Inspect India
Evals suite for assessing model performance in the Indian context.

## At a glance

| | |
|---|---|
| Upstream | [`register/inspect-india-bharatbbq`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/register/inspect-india-bharatbbq) |
| Group | — |
| Total samples | 0 |
...
```bash
inspect eval inspect_evals/bharatbbq \
  --sample-id "<sample-id>" \
